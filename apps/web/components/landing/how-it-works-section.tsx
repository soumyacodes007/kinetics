...
const steps = [
  {
    ...
    description: "Link any MCP-compatible agent to Kinetics. Configure read/write permissions. Your agents now have a shared, portable memory layer powered by 0G Chain.",
    code: `const kinetics = new Kinetics({
  agent: claude,
...
// agent connected`,
  },
  {
    number: "02",
    title: "Store",
    subtitle: "encrypted memories",
    description: "Agents write context, decisions, and knowledge to your vault. Everything is encrypted end-to-end. You control what's stored and who accesses it.",
    code: `await kinetics.store({
  key: 'project-context',
  ...
  },
  {
    number: "03",
    title: "Monetize",
    subtitle: "skill packs",
    description: "Extract valuable workflows into skill packs. Mint as iNFTs. Set time-based licenses. Other builders and agents can purchase and use your expertise.",
    code: `const pack = await kinetics.createPack({
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/10">Monetize.</span>
            </h2>
          </div>
